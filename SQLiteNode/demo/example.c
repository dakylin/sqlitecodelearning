...
/*
* After copy sqlite.h and libsqlite.a from build sqlite folder, use the below command to build the example
* gcc example.c -I. -static -L. -lsqlite -lgdbm -o example -O0 -g
*/